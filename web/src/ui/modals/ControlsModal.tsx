      ...
      <div className="modal">
        ...
        <div className="modalBody">
          ...
          <div className="row">
            ...
            <div className="runBtns" style={{ marginTop: 10 }}>
              <button className={`btn ${props.lineHeight <= 1.26 ? "primary" : "ghost"}`} onClick={() => props.setLineHeight(1.24)}>
                Tight
              </button>
              <button
                className={`btn ${props.lineHeight > 1.26 && props.lineHeight < 1.38 ? "primary" : "ghost"}`}
                onClick={() => props.setLineHeight(1.32)}
              >
                Normal
              </button>
              <button className={`btn ${props.lineHeight >= 1.38 ? "primary" : "ghost"}`} onClick={() => props.setLineHeight(1.44)}>
                Loose
              </button>
            </div>
            <div className="runBtns" style={{ marginTop: 10 }}>
          ...
          <div className="row">
            ...
            <div className="runBtns" style={{ marginTop: 10 }}>
              <button className="btn danger" disabled={!s?.id || Boolean(s?.running)} onClick={props.onRemoveSession}>
                Remove session
              </button>
